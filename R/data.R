...
#'
#' @description
#' Budget lines from the German federal budget ('Bundeshaushalt') that were
#' assessed for digitalisation content by the Agora Digitale Transformation
#' research project. The dataset covers five fiscal years: 2019, 2021, 2023,
#' 2024, and 2025. Roughly 61 incomplete records (missing `soll` or
...
#'   *Digitalhaushalt Open Data*, \doi{10.5281/zenodo.XXXXXXX}.
#'   Licensed under CC BY-SA 4.0
#'   (\url{https://creativecommons.org/licenses/by-sa/4.0/}).
#'   Cite as: Agora Digitale Transformation (2025).
#'
#' @seealso [kat_labels], [hf_labels], [of_labels], [gruppe_labels],
#'   [texan_keywords]
#'
#' @examples
#' data(digitalhaushalt)
#'
#' # How many confirmed digital lines per year?
#' table(digitalhaushalt$jahr, !is.na(digitalhaushalt$kategorie))
#'
#' # Total planned digital spending (narrow) per year, EUR billion
#' aggregate(digi_soll_eng ~ jahr,
#'           data = digitalhaushalt,
#'           FUN  = function(x) sum(x, na.rm = TRUE) / 1e6)
"digitalhaushalt"
